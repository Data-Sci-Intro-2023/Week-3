...
... where NAME is what we want to name the function; ARGUMENTS are the variables in the code that get "tweaked"; ACTIONS are the lines of code we want the function to perform (which includes our <ARGUMENTS); and the

<OUTPUT>

is the object we want as the final outcome of running the function.
...
```{r}
EVER <- unit_visitation("EVER","01","1990","12","2021")

ROMO <- unit_visitation("ROMO","01","1990","12","2021")

THRO <- unit_visitation("EVER","01","1990","12","2021")
```
...
EVER <- unit_visitation("EVER", start_year = "1980", end_year = "2021")

ROMO <- unit_visitation("ROMO", start_year = "1980", end_year = "2021")

THRO <- unit_visitation("EVER", start_year = "1980", end_year = "2021")
```
...
output_map <- parks %>% map(~ unit_visitation(park = ., start_year = '1980', end_year = '2021')) %>%
  bind_rows()
```
